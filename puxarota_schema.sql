...
# Single-tenant app — admin policies use is_puxarota_admin() without
# referencing a tenant column. This is correct by design.
[lint.rules.SEC005]
disable = true

# Tables with nullable discriminator columns (user_id, account_id).
# NULL = "not assigned yet" — intentional sentinel.
[lint.rules.SEC030]
disable = true
