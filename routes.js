(function () {
  ...
  const ROUTES = [
...

    {
      ...
      badge: { id: "explorador-beneficios", icon: "", name: "Explorador de Benefícios", description: "Concluiu a jornada educativa sobre cart�o pré-pago, cripto, USDT e cashback." },

      sponsor: "Conte�do educativo � link de indica��o",

      lessons: [

        { title: "Cartão pré-pago: o que �", eyebrow: "LI��O 1 � 2 MIN", summary: "� um cart�o que voc� carrega antes de usar: paga direto do saldo que j� est� l�. Sem fatura, sem parcelamento e sem surpresa no fim do m�s.", learn: ["Cartão pré-pago n�o � cr�dito: voc� coloca o dinheiro antes de gastar.", "D� para pagar com o app ou aproximando o celular (NFC), sempre do seu saldo.", "O limite de gasto � o que foi carregado  voc� controla quanto usa."], checkpoint: { question: "Cartão pré-pago �", options: ["Pago com o saldo que voc� carrega antes", "Um cr�dito com fatura no fim do m�s"], correct: 0 }, done: "Avan�ar" },
...

    {
      ...
      title: "N�o caia nos golpes da estrada", short: "Reconheça o alerta antes de agir.", icon: "",
  ...
  const SCENE_DECOS = {
    ...
    card: { icon: "", label: "cart�o pré-pago" },
  ...
  function renderLocked() {
    ...
    root.innerHTML = `<section class="routes-gate">
      ...
      <div class="gate-benefits">
        ...
        <article><i></i><b>Conte�do �til</b><small>Benefícios e seguran�a</small></article>
