...
if (!user) throw new Error('The confirmed administrator account does not exist yet. Create and confirm it first.');
...
console.log('Administrator access confirmed for the approved account.');
