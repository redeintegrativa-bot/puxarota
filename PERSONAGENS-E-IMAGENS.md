...
- Poses novas do Fiel geradas no Pollinations (teach/wave/sleep) foram **revertidas** —
  mantidas apenas as poses originais de cada personagem. A troca Faro→Fiel segue
  vigente: as rotas `beneficios-ripio` e `empresa-contratacao-responsavel` usam
  `mascot: "rupi"`.
